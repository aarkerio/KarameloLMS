...
*/
# file: APP/Plugin/Scorm/Model/ScormVclassroom.php

class ScormVclassroom extends ScormAppModel {
 ...
 *  @var string
 */
  public $useTable = 'scorms_vclassrooms';
