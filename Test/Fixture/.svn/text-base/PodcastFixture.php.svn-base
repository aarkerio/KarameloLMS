 ...
 * File: APP/Test/Fixture/PodcastFixture.php
 */
class PodcastFixture extends CakeTestFixture {
    
 /*
  * Optional Importing table information and records
  */
   #public $import = array('Model' => array('Podcast'), 'connection' => 'default');
