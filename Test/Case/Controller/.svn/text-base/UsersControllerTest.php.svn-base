 ...
 */
  public function setUp() 
  {
	...
	$this->Users->Security = $this->getMock('SecurityComponent', Null, array($this->Users->Components)); # PHPUnit Mock
	$this->Users->User->Aro->useDbConfig = $this->Users->User->useDbConfig;
	$this->Users->request->params['controller'] = 'users';
	$this->Users->request->params['password'] = array();
	$this->Users->request->params['email'] = array();
