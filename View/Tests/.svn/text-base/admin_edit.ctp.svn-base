...
<?php 
 ...
 echo $this->Gags->helps('Display test one question at time or all question in one single page', $helps);
 echo $this->Form->input('Test.type', array('options'=>array('1'=>__('Single page'),'0'=>__('One question at time')), 'label' => __('Quizz Display'))); 
