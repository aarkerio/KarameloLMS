...
*/
# file: APP/Model/TestVclassroom.php

class TestVclassroom extends AppModel {
 ...
 *  @var string
 */
  public $useTable = 'tests_vclassrooms';
 ...
 */
  public $belongsTo = array(
                              'Test', 'Vclassroom'  # test_vclassrooms is the SQL table
                           );
