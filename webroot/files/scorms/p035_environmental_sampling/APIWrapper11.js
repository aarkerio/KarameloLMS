...
function LMSInitialize()
{
   ...
   if( lmsInitCalled == false )
   {
      ...
      if( this.parent.apiHandle ) 
      {  
         this.parent.lmsInitCalled = lmsInitCalled;
         this.parent.lmsFinishCalled = lmsFinishCalled;
      }
...
function LMSIsInitialized()
{
   ...
   else
   {
      ...
      {
        var errCode = parseInt( api.LMSGetLastError().toString() );
